        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Working Hours</h3>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <MessageSquare className="text-blue-700 h-5 w-5 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">General Inquiries</h4>
                    <p className="text-gray-600">For general questions about our company or services</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <MessageSquare className="text-blue-700 h-5 w-5 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Project Quotes</h4>
                    <p className="text-gray-600">For detailed information about pricing and timelines</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">For assistance with ongoing projects or services</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
            {officeLocations.map((office, index) => (
              <div key={index} className="bg-gray-50 rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-4 text-gray-900">{office.name}</h3>
                  <div className="space-y-3">
                    <div className="flex items-start">
                      <MapPin className="text-blue-700 h-5 w-5 mt-1 mr-3 flex-shrink-0" />
                      <span className="text-gray-600">{office.address}</span>
                    </div>
                    <div className="flex items-start">
                      <Phone className="text-blue-700 h-5 w-5 mt-1 mr-3 flex-shrink-0" />
                      <span className="text-gray-600">{office.phone}</span>
                    </div>
                    <div className="flex items-start">
                      <Mail className="text-blue-700 h-5 w-5 mt-1 mr-3 flex-shrink-0" />
                      <span className="text-gray-600">{office.email}</span>
                    </div>
                    <div className="flex items-start">
                      <Clock className="text-blue-700 h-5 w-5 mt-1 mr-3 flex-shrink-0" />
