  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative h-[50vh] lg:h-[60vh] min-h-[400px] overflow-hidden">
          {/* Background Image */}
          {project.imageUrl ? (
            <Image
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4 lg:px-8">
              <div className="max-w-4xl">
                ...
                <nav className="mb-8 animate-fade-in" style={{ marginTop: '80px' }}>
                  <Link 
                    href="/projects"
                    className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-md rounded-full text-white/90 hover:text-white hover:bg-white/20 transition-all duration-300 border border-white/20"
                  >
                    <ArrowLeft className="w-4 h-4 mr-2" />
                    Back to Projects
                  </Link>
                ...
                <div className="mb-6 animate-slide-up">
                  <span className="px-4 py-2 bg-blue-600/90 backdrop-blur-sm text-white text-sm font-semibold rounded-full border border-blue-400/30 shadow-lg">
                    {project.category}
                  </span>
                </div>
                
                {/* Main Title - Reduced Size */}
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight animate-slide-up-delay-1">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">{project.shortDescription}</p>
                </div>
                ...
                <div className="flex-shrink-0">
                  <div className="flex flex-wrap gap-2 justify-end">
                    ...
                    <button
                      ...
                      className="group flex items-center justify-center w-8 h-8 bg-[#1877F2] text-white rounded-lg hover:bg-[#166FE5] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                    ...
                    <button
                      ...
                      className="group flex items-center justify-center w-8 h-8 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#0C85D0] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                    ...
                    <button
                      ...
                      className="group flex items-center justify-center w-8 h-8 bg-[#0A66C2] text-white rounded-lg hover:bg-[#004182] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                    ...
                    <button
                      ...
                      className="group flex items-center justify-center w-8 h-8 bg-[#25D366] text-white rounded-lg hover:bg-[#128C7E] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                    ...
                    <button
                      ...
                      className="group flex items-center justify-center w-8 h-8 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                      title="Copy Link"
                    >
                    ...
                    {typeof navigator !== 'undefined' && 'share' in navigator && (
                      <button
                        ...
                        className="group flex items-center justify-center w-8 h-8 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
                        title="Share Project"
                      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {project.technologies && project.technologies.length > 0 && (
                <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">Technologies & Materials</h2>
                ...
                <div className="space-y-6">
                  {project.projectType && (
                    <div>
                      ...
                      <p className="text-gray-900 font-medium">{project.projectType}</p>
                    </div>
                  )}
                  ...
                  {project.projectArea && (
                    <div>
                      <label className="block text-sm font-medium text-gray-500 mb-1">Project Area</label>
                  ...
                  >
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-gray-600 text-sm mb-3">{relatedProject.category}</p>
